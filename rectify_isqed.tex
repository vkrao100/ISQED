...
We state the {\it multi-fix rectification theorem} that checks
...
$\textit{k}$ = composite field size (degree of primpoly), 
PF = time for polynomial factorization and computing $P_k(X)$, RT = Chosen targets rectify the circuit (Yes (Y) / No (N)), 
...
VMS = time for verification and MFR setup, RC = time for MFR check, TE = Total execution time.}}
\label{exptbl}
...
\multicolumn{5}{!{\vrule width 1pt} c !{\vrule width 1pt}}{} & \multicolumn{5}{ c !{\vrule width 1pt}}{Mastrovito} & \multicolumn{5}{ c !{\vrule width 1pt}}{Montgomery} & \multicolumn{5}{ c !{\vrule width 1pt}}{Point Addition}\\ \noalign{\hrule height 1pt}
{\textit{\textbf{n}}} & {\textit{\textbf{m}}} & {\textit{\textbf{k}}} & {\textbf{PF}} & {\textbf{RT}} & {\textbf{\#G}} & {\textbf{PBS}} & {\textbf{VMS}} & {\textbf{RC}} & {\textbf{TE}}& {\textbf{\#G}} & {\textbf{PBS}} & {\textbf{VMS}} 
& {\textbf{RC}} & {\textbf{TE}}& {\textbf{\#G}} & {\textbf{PBS}} & {\textbf{VMS}} & {\textbf{RC}} & {\textbf{TE}}\\ \noalign{\hrule height 1pt}
...
\mb{16}  & \mb{5} & \mb{80  } & 0.03 & Y & 0.8  & 0.04   & 0.03  & 0.12  & 0.22  & 0.9   & 0.04  & 0.48 & 35.33    & 35.88 & 0.9  & 0.06 & 0.08 & 1.73  & 1.9   \\ \hline
\mb{32 } & \mb{5} & \mb{160 } & 0.05 & Y & 2.8  & 0.13   & 0.06  & 0.4   & 0.65  & 2.8   & 0.13  & 0.54 & 27.61    & 28.33 & 2.9  & 0.18 & 0.53 & 133.9 & 134.6 \\ \hline
\mb{64 } & \mb{3} & \mb{192 } & 0.05 & Y & 11.2 & 0.57   & 0.54  & 226.7 & 227.9 & 9.6   & 0.52  & 0.27 & 1.79     & 2.63  & 10.6 & 0.84 & 0.45 & 58.14 & 59.48 \\ \hline
\mb{96 } & \mb{2} & \mb{96  } & 0.05 & Y & 24.5 & 1.47   & 0.21  & 0.83  & 2.56  & 21    & 1.36  & 1.19 & 13.32    & 15.92 & 24.8 & 2.46 & 0.57 & 14.93 & 18    \\ \hline
\mb{128} & \mb{2} & \mb{128 } & 0.1  & Y & 43.2 & 3.23   & 0.4   & 2.03  & 5.76  & 35.8  & 2.8   & 1.3  & 64.23    & 68.43 & 43.2 & 6.45 & 1.55 & 72.83 & 80.93 \\ \hline
\mb{163} & \mb{5} & \mb{815 } & 2.4  & Y & 69.8 & 6.04   & 1.03  & 11.86 & 21.33 & 57.5  & 5.19  & 4.34 & 262.4    & 274.4 & 71.6 & 15.72& 2.31 & 14.97 & 35.4  \\ \hline
\mb{233} & \mb{2} & \mb{466 } & 0.2  & Y & 119  & 13     & 1     & 0.01  & 14.2  & 112   & 11.5  & 3.4  & 360      & 375   & 122  & 19.2 & 1.5  & 0.15  & 21.5  \\ \hline
\mb{283} & \mb{2} & \mb{566 } & 0.4  & Y & 190  & 38     & 1.9   & 0.1   & 42.3  & 171   & 35    & 9.2  & 1503     & 1549  & 208  & 80.4 & 4.1  & 0.1   & 86.6  \\ \hline
\mb{409} & \mb{2} & \mb{818 } & 1    & Y & 384  & 190    & 3.6   & 0.1   & 195   & 340   & 134   & 9    & 4920*    & 5064  & 368  & 220  & 7    & 2007  & 2237  \\ \hline
\mb{571} & \mb{2} & \mb{1042} & 2    & Y & 827  & 2150   & 8.9   & 0.1   & 2162  & 663   & 1313  & 73   & 0.2$\td$ & 1395  & 813  & 2583 & 17.7 & 880   & 3490  \\ \hline\hline
\mb{16}  & \mb{7} & \mb{112 } & 0.03 & N & 0.8  & 0.04   & 0.11  & 4.96  & 5.14  & 0.9   & 0.05  & 1.54 & 228.1    & 229.7 & 0.9  & 0.05 & 0.62 & 32.85 & 33.55 \\ \hline
\mb{32 } & \mb{5} & \mb{160 } & 0.05 & N & 2.8  & 0.13   & 0.04  & 0.81  & 1.03  & 2.8   & 0.13  & 0.95 & 100.1    & 101.2 & 2.9  & 0.18 & 0.71 & 243.6 & 244.5 \\ \hline
\mb{64 } & \mb{3} & \mb{192 } & 0.05 & N & 11.2 & 0.58   & 0.18  & 1.64  & 2.45  & 9.6   & 0.51  & 0.39 & 10.43    & 11.38 & 10.6 & 0.79 & 0.25 & 3.96  & 5.05  \\ \hline
\mb{96 } & \mb{2} & \mb{96  } & 0.05 & N & 24.5 & 1.48   & 0.2   & 0.04  & 1.77  & 21    & 1.34  & 2.04 & 87.45    & 90.88 & 24.8 & 2.44 & 0.62 & 35.46 & 38.57 \\ \hline
\mb{128} & \mb{2} & \mb{128 } & 0.1  & N & 43.2 & 3.21   & 0.43  & 0.1   & 3.84  & 35.8  & 2.7   & 1.3  & 66       & 70    & 43.2 & 6.1  & 1    & 73    & 81    \\ \hline
\mb{163} & \mb{5} & \mb{815 } & 2.4  & N & 69.8 & 6.3    & 1.06  & 12    & 21.72 & 57.5  & 5.31  & 5.26 & 524.3    & 537.3 & 71.6 & 15.77& 2.46 & 36.98 & 57.6  \\ \hline
\mb{409} & \mb{2} & \mb{818 } & 1    & N & 384  & 208.1  & 3.76  & 0.03  & 212   & 340   & 126.8 & 6.76 & 0.13     & 134.7 & 368  & 210  & 8.04 & 927.5 & 1146  \\ \hline
\mb{571} & \mb{2} & \mb{1042} & 2    & N & 827  & 2246   & 8.53  & 0.11  & 2256  & 663   & 1358  & 62.27& 2.24     & 1424  & 813  & 2433 & 16.7 & 4.94  & 2457  \\ \noalign{\hrule height 1pt}
...
% \multicolumn{5}{!{\vrule width 1pt} c !{\vrule width 1pt}}{} & \multicolumn{6}{ c !{\vrule width 1pt}}{Mastrovito} & \multicolumn{6}{ c !{\vrule width 1pt}}{Montgomery} 
% & \multicolumn{6}{ c !{\vrule width 1pt}}{Point Addition}\\ \noalign{\hrule height 1pt}{\textit{\textbf{n}}} & {\textit{\textbf{m}}} & {\textit{\textbf{k}}} & {\textbf{PF}} 
% & {\textbf{RT}} & {\textbf{\#G}} & {\textbf{BO}} & {\textbf{PBS}} & {\textbf{VMS}} & {\textbf{RC}} & {\textbf{TE}}& {\textbf{\#G}} & {\textbf{BO}} & {\textbf{PBS}} 
% & {\textbf{VMS}} & {\textbf{RC}} & {\textbf{TE}}& {\textbf{\#G}} & {\textbf{BO}} & {\textbf{PBS}} & {\textbf{VMS}} & {\textbf{RC}} & {\textbf{TE}}\\ \noalign{\hrule height 1pt}
% %\mb{16}  & \mb{3} & \mb{48}   & 0.03 & Y & 0.8  & 0.04   & 0.02  & 0.01  & 0.10  & 0.9   & 0.1   & 0.2  & 3    & 3.15 & 0.9  & 0.1  & 0.2  & 72    & 74    \\ \hline
% %\mb{32 } & \mb{2} & \mb{32 }  & 0.03 & Y & 2.8  & 0.13   & 0.02  & 0.01  & 0.19  & 2.8   & 0.12  & 0.2  & 0.8  & 1    & 2.9  & 0.17 & 0.2  & 0.98  & 1.2   \\ \hline
% %\mb{48 } & \mb{3} & \mb{48  } & 0.04 & Y & 12.2 & 0.6    & 0.29  & 0.01  & 0.8   & 6.4   & 0.5   & 0.4  & 0.1  & 0.9  & 6.4  & 0.5  & 0.4  & 0.1   & 0.9   \\ \hline
% %\mb{96 } & \mb{7} & \mb{672 } & 1.4  & Y & 24.5 &        &       &       &       & 21    &       &      &      &      & 24.8 &      &      &       &       \\ \hline
...
% %\mb{32 } & \mb{7} & \mb{224 } & 0.07 & N & 2.8  &        &       &       &       & 2.8   &       &      &      &      & 2.9  &      &      &       &       \\ \hline
% %\mb{163} & \mb{2} & \mb{326 } & 0.15 & Y & 69.8 & 6.25   &  0.68 & 2.0   & 9.08  & 57.5  & 5.2   & 3.3  & 295   & 305   & 71.6 & 16.1 & 1.9  & 735   & 754   \\ \hline
% \mb{16}  & \mb{5} & \mb{80  } & 0.03 & Y & 0.8  & 10 & 0.04   & 0.03  & 0.12  & 0.22  & 0.9  & 16 & 0.04  & 0.48 & 35.33    & 35.88 & 0.9  & 7  & 0.06 & 0.08 & 1.73  & 1.9   \\ \hline
% \mb{32 } & \mb{5} & \mb{160 } & 0.05 & Y & 2.8  & 8  & 0.13   & 0.06  & 0.4   & 0.65  & 2.8  & 32 & 0.13  & 0.54 & 27.61    & 28.33 & 2.9  & 13 & 0.18 & 0.53 & 133.9 & 134.6 \\ \hline
% \mb{64 } & \mb{3} & \mb{192 } & 0.05 & Y & 11.2 & 5  & 0.57   & 0.54  & 226.7 & 227.9 & 9.6  & 47 & 0.52  & 0.27 & 1.79     & 2.63  & 10.6 & 64 & 0.84 & 0.45 & 58.14 & 59.48 \\ \hline
% \mb{96 } & \mb{2} & \mb{96  } & 0.05 & Y & 24.5 & 5  & 1.47   & 0.21  & 0.83  & 2.56  & 21   & 96 & 1.36  & 1.19 & 13.32    & 15.92 & 24.8 & 96 & 2.46 & 0.57 & 14.93 & 18    \\ \hline
% \mb{128} & \mb{2} & \mb{128 } & 0.1  & Y & 43.2 &    & 3.23   & 0.4   & 2.03  & 5.76  & 35.8 &    & 2.8   & 1.3  & 64.23    & 68.43 & 43.2 & 22 & 6.45 & 1.55 & 72.83 & 80.93 \\ \hline
% \mb{163} & \mb{5} & \mb{815 } & 2.4  & Y & 69.8 & 6  & 6.04   & 1.03  & 11.86 & 21.33 & 57.5 & 128& 5.19  & 4.34 & 262.4    & 274.4 & 71.6 &    & 15.72& 2.31 & 14.97 & 35.4  \\ \hline
% \mb{233} & \mb{2} & \mb{466 } & 0.2  & Y & 119  &    & 13     & 1     & 0.01  & 14.2  & 112  &    & 11.5  & 3.4  & 360      & 375   & 122  &    & 19.2 & 1.5  & 0.15  & 21.5  \\ \hline
% \mb{283} & \mb{2} & \mb{566 } & 0.4  & Y & 190  &    & 38     & 1.9   & 0.1   & 42.3  & 171  &    & 35    & 9.2  & 1503     & 1549  & 208  &    & 80.4 & 4.1  & 0.1   & 86.6  \\ \hline
% \mb{409} & \mb{2} & \mb{818 } & 1    & Y & 384  &    & 190    & 3.6   & 0.1   & 195   & 340  &    & 134   & 9    & 4920*    & 5064  & 368  & 409& 220  & 7    & 2007  & 2237  \\ \hline
% \mb{571} & \mb{2} & \mb{1042} & 2    & Y & 827  &    & 2150   & 8.9   & 0.1   & 2162  & 663  &    & 1313  & 73   & 0.2$\td$ & 1395  & 813  &    & 2583 & 17.7 & 880   & 3490  \\ \hline\hline
% \mb{16}  & \mb{7} & \mb{112 } & 0.03 & N & 0.8  & 11 & 0.04   & 0.11  & 4.96  & 5.14  & 0.9  & 13 & 0.05  & 1.54 & 228.1    & 229.7 & 0.9  & 12 & 0.05 & 0.62 & 32.85 & 33.55 \\ \hline
% \mb{32 } & \mb{5} & \mb{160 } & 0.05 & N & 2.8  & 8  & 0.13   & 0.04  & 0.81  & 1.03  & 2.8  & 32 & 0.13  & 0.95 & 100.1    & 101.2 & 2.9  & 13 & 0.18 & 0.71 & 243.6 & 244.5 \\ \hline
% \mb{64 } & \mb{3} & \mb{192 } & 0.05 & N & 11.2 & 5  & 0.58   & 0.18  & 1.64  & 2.45  & 9.6  & 47 & 0.51  & 0.39 & 10.43    & 11.38 & 10.6 & 5  & 0.79 & 0.25 & 3.96  & 5.05  \\ \hline
% \mb{96 } & \mb{2} & \mb{96  } & 0.05 & N & 24.5 & 5  & 1.48   & 0.2   & 0.04  & 1.77  & 21   & 96 & 1.34  & 2.04 & 87.45    & 90.88 & 24.8 & 96 & 2.44 & 0.62 & 35.46 & 38.57 \\ \hline
% \mb{128} & \mb{2} & \mb{128 } & 0.1  & N & 43.2 &    & 3.21   & 0.43  & 0.1   & 3.84  & 35.8 &    & 2.7   & 1.3  & 66       & 70    & 43.2 &    & 6.1  & 1    & 73    & 81    \\ \hline
% \mb{163} & \mb{5} & \mb{815 } & 2.4  & N & 69.8 & 6  & 6.3    & 1.06  & 12    & 21.72 & 57.5 & 128& 5.31  & 5.26 & 524.3    & 537.3 & 71.6 &    & 15.77& 2.46 & 36.98 & 57.6  \\ \hline
% \mb{409} & \mb{2} & \mb{818 } & 1    & N & 384  & 2  & 208.1  & 3.76  & 0.03  & 212   & 340  & 11 & 126.8 & 6.76 & 0.13     & 134.7 & 368  & 3  & 210  & 8.04 & 927.5 & 1146  \\ \hline
% \mb{571} & \mb{2} & \mb{1042} & 2    & N & 827  & 331& 2246   & 8.53  & 0.11  & 2256  & 663  & 427& 1358  & 62.27& 2.24     & 1424  & 813  &    & 2433 & 16.7 & 4.94  & 2457  \\ \noalign{\hrule height 1pt}
% \end{tabular}\vspace{- 0.25in}  
% \end{table*}
