...
% correct IEEE style idcaptions. The latest version and documentation of
...
% affiliations
% \author{\IEEEauthorblockN{Vikas Rao}
...
% Fax: (888) 555--1212}}
\author{Vikas Rao$^1$, Irina Ilioaea$^2$, Haden Ondricek$^1$, Priyank Kalla$^1$,  and Florian Enescu$^3$\\
...
% in the abstract     
\input{abstract_isqed.tex}
\input{intro_isqed.tex}
\input{prelim_isqed_pk.tex} 
\input{poly_model_isqed_pk.tex}
\input{comp_setup_isqed_pk1.tex}
\input{rectify_isqed_pk.tex}
\input{experiments_isqed.tex}
